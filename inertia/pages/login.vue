<template>
  <div class="bg-slate-100 min-h-screen flex flex-col items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
      ...
      <div v-if="props.error" class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-100 border border-red-300 text-center">
        {{ props.error }}
      </div>
...
const loginRequest = () => { loginForm.post('/login') }
</script>