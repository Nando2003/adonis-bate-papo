    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
      ...
      <form @submit.prevent="registerRequest" class="space-y-6">
        ...
        <div class="space-y-2">
          ...
          <p v-if="registerForm.errors.email" class="mt-1 text-sm text-red-600">{{ registerForm.errors.email }}</p>
        </div>
        ...
        <div class="space-y-2">
          ...
          <input 
            ...
            required
            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" />
          <p v-if="registerForm.errors.password" class="mt-1 text-sm text-red-600">{{ registerForm.errors.password }}</p>
        </div>
        ...
        <div class="space-y-2">
          ...
          <input 
            ...
            required
            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm" />
          <p v-if="registerForm.errors.passwordConfirmation" class="mt-1 text-sm text-red-600">{{ registerForm.errors.passwordConfirmation }}</p>
        </div>
...
const registerRequest = () => { registerForm.post('/register') }
</script>